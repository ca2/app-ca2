...
namespace twitter_auto
{
   ...
   void pane_view::_001OnCreate(::message::message * pobj)
   {
      ...
      add_tab("Twitter Auto", ::twitter_auto::PaneViewTwitterAutomator, true, true);
      add_tab("Import", "file_manager:import", true, true);
      add_tab("Export", "file_manager:export", true, true);

      set_cur_tab_by_id(::twitter_auto::PaneViewTwitterAutomator);
   ...
   void pane_view::on_show_view()
   {
      ...
      else if (m_pviewdata->m_id == "file_manager:export")
      {
         ...
         m_pdocMain->m_filepath = "Twitter Auto.csv";
   ...
   void pane_view::on_create_impact(::user::impact_creator_data * pcreatordata)
   {
      ...
      {
         m_pdocMain=dynamic_cast < document * > (Application.m_ptemplateTwitterAutomatorFormList->open_document_file(var(), true, pcreatordata->m_pholder));
      }
