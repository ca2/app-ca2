...
retry:
      ...
      m_strLastRequest = "twitter::twitter_auto(\"" + string(pszMessage) + "\") iRetry=" + ::str::from(iRetry);
...
request_authorization:
   ...
   string twitter::twitter_automator_noauth(const char * pszMessage, stringa straMediaIds, string strReplyStatusId)
   {
      ...
      bool bOk = twit.statusUpdate(strSend, straMediaIds, strReplyStatusId);
