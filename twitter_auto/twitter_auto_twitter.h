...
namespace twitter_auto
{
   ...
   class CLASS_DECL_APP_CORE_TWITTER_AUTO twitter :
   ...
   public:
      ...
      virtual string twitter_automator_noauth(const char * pszMessage, stringa straMediaIds, string strReplyStatusId);
