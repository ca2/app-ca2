...
Section "twitter_automator (required)"
  ...
  File "C:\eco\time\x64\cover\wndfrm_metro.dll"
  ...
  File "C:\eco\time\x64\cover\gcom.dll"
  ...
  File "C:\eco\time\x64\cover\app_core.dll"
  File "C:\eco\time\x64\cover\app_ca2_twitter_automator.dll"
  File "C:\eco\time\x64\cover\app_ca2_twitter_automator.exe"
  ...
  File "C:\eco\time\x64\cover\wndfrm_metro.pdb"
  ...
  File "C:\eco\time\x64\cover\gcom.pdb"
  ...
  File "C:\eco\time\x64\cover\app_core.pdb"
...
installed_redist:
  ...
  ;we are done
  ExecWait '"$INSTDIR\time\x64\cover\app_ca2_twitter_automator.exe" : install' $0
  ...
  CreateShortCut "$DESKTOP\Twitter Automator.lnk" "$INSTDIR\time\x64\cover\app_ca2_twitter_automator.exe" ""
...
Section "Start Menu Shortcuts"
  ...
  CreateShortcut "$SMPROGRAMS\Twitter Automator\Twitter Automator.lnk" "$INSTDIR\time\x64\cover\app_ca2_twitter_automator.exe" "" "$INSTDIR\time\x64\cover\app_ca2_twitter_automator.exe" 0
