...
//
//   PURPOSE: Register the action_context menu handler.
//
//   PARAMETERS:
//   * pszFileType - The file type that the action_context menu handler is
...
//
//   PURPOSE: Unregister the action_context menu handler.
//
//   PARAMETERS:
//   * pszFileType - The file type that the action_context menu handler is
//     associated with. For example, '*' means all file types; '.txt' means
