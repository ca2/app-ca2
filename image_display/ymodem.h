...
extern unsigned long ymodem_receive(struct serial_serial * pserial, unsigned char *buf, unsigned long length);
extern unsigned long ymodem_send(struct serial_serial * pserial, unsigned char *buf, unsigned long size, char* filename, void (*pfnBytesSent)(struct serial_serial * pserial, int));
