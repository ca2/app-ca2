...
//      m_iCom = -1;
      ...
      m_strAppName = "app/quasar_science_update_utility";
      m_strLibraryName = "app/quasar_science_update_utility";
...
//   }
   ...
   void application::on_request(::create * pcreate)
   {
      ...
      fork([&]()
      {
         ...
         output_debug_string("\nfinished quasar_science_update_utility::on_request");
   ...
   void application::update()
   {

      {
         ...
         if (iState == 5)
         {
            ...
            iState = (int)ymodem_send(m_m.get_data(), (int)(u32)m_m.get_size(), (char*)(const char*)strFileName, &::quasar_science_update_utility::total_progress);
...
extern "C"
::aura::library * app_quasar_science_update_utility_get_new_library(::aura::application * papp)
{

   return new ::aura::single_application_library < ::quasar_science_update_utility::application >(papp, "app/quasar_science_update_utility");
...
extern "C"
{
   ...
   void _putchar(int c)
   {
      ...
      quasar_science_update_utility::application::m_pserial->write(&ui, sizeof(ui));
   ...
   int  _getchar(int timeout)
   {
      ...
      if (timeout < 0)
      {
         ...
         while (true)
         {
            ...
            if (quasar_science_update_utility::application::m_pserial->read(&ui, sizeof(ui)) >= 1)
            {
      ...
      else
      {
         ...
         do
         {
            ...
            int iRes = (int) quasar_science_update_utility::application::m_pserial->read(&ui, sizeof(ui));
...
void quasar_science_update_utility_set_main_interface(main_interface ** pmaininterface)
{
   ...
   *pmaininterface = ::quasar_science_update_utility::g_papp;
