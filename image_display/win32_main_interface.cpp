...
void main_interface::on_check_version_response(const char * pszStatus, bool bEnable)
{
   ...
   m_pmainwindow->m_dlg1.m_versionStatus._set_window_text(pszStatus);
...
void main_interface::on_radio_download_response(bool bDownloadEnable, bool bUpdateEnable)
{
   ...
   m_pmainwindow->m_emode = main_interface::mode_normal;
...
void main_interface::on_radio_latest_response(bool bUpdateEnable)
{
   ...
   m_pmainwindow->m_emode = main_interface::mode_browse;
...
void main_interface::on_download_response(const char * pszStatus, bool bUpdateEnable)
{
   ...
   m_pmainwindow->m_dlg1.m_downloadProgress._set_window_text(pszStatus);
...
void main_interface::on_app_installation_response(const char * pszStatus)
{
   ...
   m_pmainwindow->m_labelApp._set_window_text(pszStatus);
...
void main_interface::set_result(const char * pszPort, const char * psz)
{
   ...
   m_pmainwindow->m_dlg2.m_result._set_window_text(psz);
...
void main_interface::set_progress(const char * pszPort, int iPercent, const char * pszStatus)
{
   ...
   if (iPercent == 0)
   {
      ...
      m_pmainwindow->m_dlg2.m_uploadProgress._set_window_text("");

   }
   else
   {

      m_pmainwindow->m_dlg2.m_uploadProgress._set_window_text(strStatus);
...
void main_interface::to_close()
{
   ...
   m_pmainwindow->m_cancel._set_window_text(_("Close"));
...
void main_interface::to_cancel()
{
   ...
   m_pmainwindow->m_cancel._set_window_text(_("Cancel"));
...
void main_interface::on_app_check_version(const char * pszChar)
{
   ...
   m_pmainwindow->m_labelApp._set_window_text(pszChar);
...
void main_interface::on_app_check_version_on_show()
{
   ...
   //m_pmainwindow->m_dlg1.m_bCheckVersion = false;
   //m_pmainwindow->m_dlg1.on_show();
   //m_pmainwindow->m_dlg1.m_bCheckVersion = true;
...
void main_interface::on_enable_install_downloaded_bin(const char * strTitle)
{
   ...
   m_pmainwindow->m_dlg1.m_radioInstallVersion._set_window_text(_("Install Version ") + string(strTitle));
...
void main_interface::wait_dialog_alert(const char * psz)
{
