   ...
   void application::update_port(::serial::PortInfo portinfo)
   {
      ...
      try
      {
         ...
         if (iState == 5)
         {
            ...
            iState = (int)ymodem_send(&serial, m_m.get_data(), (int)(u32)m_m.get_size(), (char*)(const char*)strFileName, &::quasar_science_update_utility::total_progress);
...
aura_app quasar_science_update_utility_flags(aura_app::flag_do_not_install);
