...
namespace quasar_science_update_utility
{
      ...
      m_dlg2(papp)
   {
      ...
      m_emode = main_interface::mode_normal;
   ...
   bool main_dialog::on_init_dialog()
   {
      ...
      //SetWindowPos(m_dlg1.m_hwnd, 0, 0, 25, 0, 0, SWP_NOZORDER | SWP_NOSIZE);
      //SetWindowPos(m_dlg2.m_hwnd, 0, 0, 25, 0, 0, SWP_NOZORDER | SWP_NOSIZE);
   ...
   void main_dialog::on_command(UINT nId)
   {
      ...
      else if (nId == IDC_UPDATE)
      {
         ...
         if (::IsWindowVisible(m_dlg1.m_hwnd))
         {
            ...
            strFirmwareVersion.Format("Firmware Version: %s", Application.m_strVersionNormal);

            m_dlg2.m_firmwareVersion._set_window_text(strFirmwareVersion);
            ...
            m_update._set_window_text(_("Back"));

            ::RedrawWindow(m_dlg2.m_hwnd, NULL, NULL, RDW_INVALIDATE | RDW_UPDATENOW);

            m_pmaininterface->start_update(m_emode);
         ...
         else
         {
            ...
            m_update._set_window_text(_("Update"));
      ...
      else if (nId == IDC_RESTART)
      {
         ...
         m_pmaininterface->start_update(main_interface::mode_normal);
   ...
   INT_PTR main_dialog::on_dialog_message(UINT uiMessage, WPARAM wparam, LPARAM lparam)
   {
      ...
      else if (uiMessage == WM_APP + 100)
      {
         ...
         m_dlg2.m_uploadProgress._set_window_text(::str::from(20 + i) + "%");
...
//            logprintf("File to be sent has no content.");
