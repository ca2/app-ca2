...
namespace user
{
   ...
   void meta_button::_001OnClip(::draw2d::graphics_pointer & pgraphics)
   {
   ...
   void meta_button::install_message_routing(::channel * pchannel)
   {
      ...
      IGUI_MSG_LINK(WM_SHOWWINDOW, pchannel, this, &meta_button::_001OnShowWindow);
   ...
   index meta_button::hit_test(const ::point & point, e_element & eelement)
   {
