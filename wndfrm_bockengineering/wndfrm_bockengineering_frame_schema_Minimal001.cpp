   ...
   namespace wndfrm
   {
      ...
      namespace frame
      {
         ...
         namespace wndfrm_bockengineering
         {
            ...
            void FrameSchemaHardCodedMinimal001::DrawBorderSide(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient, EBorder eside)
            {
...
//               EDock edock = m_pframewindow->dock_manager()->GetDockState();
            ...
            void FrameSchemaHardCodedMinimal001::on_draw_frame(::draw2d::graphics_pointer & pgraphics)
            {
            ...
            void FrameSchemaHardCodedMinimal001::DrawBorder(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient)
            {
            ...
            void FrameSchemaHardCodedMinimal001::DrawGrip(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient, EGrip egrip)
            {
            ...
            void FrameSchemaHardCodedMinimal001::DrawRectGrip(::draw2d::graphics_pointer & pgraphics,const RECT & rectParam)
            {
            ...
            void FrameSchemaHardCodedMinimal001::DrawGripSet(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient)
            {
