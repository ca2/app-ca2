   ...
   namespace wndfrm
   {
      ...
      namespace frame
      {
         ...
         namespace wndfrm_bockengineering
         {
            ...
            void FrameSchemaHardCoded011::DrawBorderSide(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient, EBorder eside)
            {
            ...
            void FrameSchemaHardCoded011::on_draw_frame(::draw2d::graphics_pointer & pgraphics)
            {
            ...
            void FrameSchemaHardCoded011::DrawBorder(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient)
            {
...
#define GRIP_LARGE 30
            ...
            void FrameSchemaHardCoded011::DrawGrip(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient, EGrip egrip)
            {
            ...
            void FrameSchemaHardCoded011::DrawRectGrip(::draw2d::graphics_pointer & pgraphics, const RECT & rectParam)
            {
            ...
            void FrameSchemaHardCoded011::DrawGripSet(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient)
            {
