   ...
   namespace wndfrm
   {
      ...
      namespace frame
      {
         ...
         namespace wndfrm_bockengineering
         {
            ...
            void FrameSchemaHardCoded001::DrawBorderSide(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient, EBorder eside)
            {
...
//               EDock edock = m_pframewindow->dock_manager()->GetDockState();
            ...
            void FrameSchemaHardCoded001::on_draw_frame(::draw2d::graphics_pointer & pgraphics)
            {
            ...
            void FrameSchemaHardCoded001::DrawBorder(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient)
            {
            ...
            void FrameSchemaHardCoded001::DrawGrip(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient, EGrip egrip)
            {
            ...
            void FrameSchemaHardCoded001::DrawRectGrip(::draw2d::graphics_pointer & pgraphics,const RECT & rectParam)
            {
            ...
            void FrameSchemaHardCoded001::DrawGripSet(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient)
            {
