      ...
      namespace frame
      {
         ...
         namespace wndfrm_bockengineering
         {
               ...
               m_fontButton(allocer())
            {
               ...
               m_fontList->create_point_font("MS Sans Serif", 9.0);
            ...
            EHitTest frame_schema::_000HitTest(const ::point & point)
            {
            ...
            */
            ...
            bool frame_schema::_000OnLButtonDown(::message::mouse * pmouse)
            {
               ...
               if (m_pframewindow->get_appearance() != ::user::appearance_zoomed && m_pframewindow->get_appearance() != ::user::appearance_full_screen)
               {

                  if (m_pframework->_000OnLButtonDown(pmouse->)
                     return true;

                  if (m_pframewindow->GetMovingManager()->_000OnLButtonDown(pmouse->)
                     return true;
            ...
            bool frame_schema::_000OnLButtonUp(::message::mouse * pmouse)
            {
               ...
               if (m_pframewindow->get_appearance() != ::user::appearance_zoomed && m_pframewindow->get_appearance() != ::user::appearance_full_screen)
               {
                  ...
                  if (m_pframework->_000OnLButtonUp(pmouse->)
                     return true;

                  if (m_pframewindow->GetMovingManager()->_000OnLButtonUp(pmouse->)
                     return true;
            ...
            bool frame_schema::_000OnMouseMove(::message::mouse * pmouse)
            {
               ...
               if (m_pframewindow->get_appearance() != ::user::appearance_zoomed && m_pframewindow->get_appearance() != ::user::appearance_full_screen)
               {
                  ...
                  if (m_pframework->_000OnMouseMove(pmouse->)
                     return true;

                  if (m_pframewindow->GetMovingManager()->_000OnMouseMove(pmouse->)
                     return true;
            ...
            bool frame_schema::_000OnNcLButtonUp(::message::mouse * pmouse)
            {
               ...
               if (m_pframewindow->get_appearance() != ::user::appearance_zoomed && m_pframewindow->get_appearance() != ::user::appearance_full_screen)
               {
                  ...
                  if (m_pframework->Relay(pmouse->)
                     return true;

                  if (m_pframewindow->GetMovingManager()->Relay(pmouse->)
                     return true;
            ...
            bool frame_schema::_000OnNcHitTest(const ::point & point, LRESULT & nHitTest)
            {
               UNREFERENCED_PARAMETER(point);
            ...
            */
            ...
            /*            bool frame_schema::_000OnTimer(u32 nIDEvent)
                        {
                        ...
                        bool frame_schema::_000OnSize(u32 nType, i32 cx, i32 cy)
                        {
                        ...
                        bool frame_schema::_000OnMove(i32 x, i32 y)
                        {
                        ...
                        bool frame_schema::_000OnDisplayChange(i32 iBitsPerPixel, size sizeScreen)
                        {
            ...
            {
               ASSERT(m_pframewindow != NULL);
               return m_pframewindow->get_appearance();
            }
            */
            ...
            void frame_schema::OnMove(__pointer(::user::interaction) pwnd)
            {
            ...
            void frame_schema::Glass(::draw2d::graphics_pointer & pgraphics, const RECT & lprect)
            {

               __pointer(::user::interaction) pwndiDraw = m_pframewindow->get_draw_window();
               ...
               ::draw2d::dib_pointer spdib(allocer());

               ::draw2d::dib_pointer spdib2(allocer());
            ...
            void frame_schema::ColorGlass(::draw2d::graphics_pointer & pgraphics, const RECT & lprect, COLORREF cr, BYTE bAlpha)
            {
            ...
            void frame_schema::set_style(const char * pszStyle)
            {
               ...
               else if (strStyle == "Rouge")
               {
                  set_style(StyleRouge);
               }
            ...
            frame_schema::e_element operator++(frame_schema::e_element & eelement, i32 i)
            {
               ...
               return (frame_schema::e_element) (*((i32*)&eelement))++;
            }
            ...
            bool frame_schema::get_element_rect(LPRECT lprect, e_element eelement)
            {
               ...
               case ElementTopLeftIcon:
                  ...
                  if (m_pframewindow->m_pappearance == NULL || m_pframewindow->m_pappearance->m_picon == NULL)
                     return false;

                  lprect->left = m_pointWindowIcon.x;
                  lprect->top = m_pointWindowIcon.y;
                  //lprect->right = lprect->left + m_pframewindow->m_pappearance->m_picon->get_size().cx;
                  //lprect->bottom = lprect->top + m_pframewindow->m_pappearance->m_picon->get_size().cy;
               ...
               case ElementMoveGripMinimal:
                  ...
                  if (m_pframewindow->m_pappearance == NULL || m_pframewindow->m_pappearance->GetAppearance() != ::user::appearance_minimal)
                     return false;
            ...
            void frame_schema::set_button_color_schema_001(COLORREF crMoveableBorder)
            {
               ...
               create_color(color_border_normal, ca.get_rgb() | (0xff << 24));

               ca.set_rgb(crBase);
               ca.hls_rate(0.0, -0.11, -0.11);
               create_color(color_background_normal, ca.get_rgb() | (0xff << 24));
            ...
            void frame_schema::Draw3dRectSide(::draw2d::graphics_pointer & pgraphics, const RECT & rectParam, EBorder eborder, COLORREF crTopLeft, COLORREF crBottomRight)
            {
            ...
            void frame_schema::_001OnDraw(::draw2d::graphics_pointer & pgraphics)
            {

               if (!m_pframewindow->IsAppearanceEnabled())
                  return;
               ...
               appearance * pappearance = m_pframewindow->get_appearance();

               if (!pappearance->IsFullScreen() && !pappearance->IsZoomed() && !pappearance->IsIconic() && !m_pframewindow->frame_is_transparent())
               {
               ...
               if (pappearance->IsMinimal())
               {
                  ...
                  if (get_element_rect(rectIcon, ElementTopLeftIcon))
                  {
                     ...
                     ::visual::icon * picon = m_pframewindow->m_pappearance->m_picon;
               ...
               else if (!pappearance->IsFullScreen() && !m_pframewindow->frame_is_transparent())
               {

                  if (m_pframewindow->get_handle() == GetActiveWindow() && m_crActiveCaptionTextBk != 0)
                  {
            ...
            void frame_schema::on_draw_frame(::draw2d::graphics_pointer & pgraphics)
            {
            ...
            bool frame_schema::is_control_box_moveable()
            {
            ...
            bool frame_schema::get_font(::draw2d::font_pointer & sp, e_font efont, ::user::interaction * pinteraction)
            {

               if (efont == font_list_item)
               {
            ...
            void frame_schema::GetFrameRect(rect * prect)
            {

               m_pframewindow->GetWindowRect(prect);
