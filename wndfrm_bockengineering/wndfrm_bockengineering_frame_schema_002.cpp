   ...
   namespace wndfrm
   {
      ...
      namespace frame
      {
         ...
         namespace wndfrm_bockengineering
         {
            ...
            void FrameSchemaHardCoded002::DrawBorderSide(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient, EBorder eside)
            {
            ...
            void FrameSchemaHardCoded002::on_draw_frame(::draw2d::graphics_pointer & pgraphics)
            {
            ...
            void FrameSchemaHardCoded002::DrawBorder(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient)
            {
...
#define GRIP_LARGE 30
            ...
            void FrameSchemaHardCoded002::DrawRectGrip(::draw2d::graphics_pointer & pgraphics,const RECT & rectParam)
            {
            ...
            void FrameSchemaHardCoded002::DrawGripSet(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient)
            {
