...
SizingNone:
            ...
            void FrameSchemaHardCoded008::DrawBorderSide(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient, EBorder eside)
            {
            ...
            void FrameSchemaHardCoded008::on_draw_frame(::draw2d::graphics_pointer & pgraphics)
            {
            ...
            void FrameSchemaHardCoded008::DrawBorder(::draw2d::graphics_pointer & pgraphics, const RECT & lpcrectClient)
            {
               ...
               if(m_bHollow)
               {
                  ...
                  if (m_pframewindow->get_handle() == GetActiveWindow())
                  {
                     ...
                     for (index i = 0; i < 9; i++)
                     {
                        ...
                        pgraphics->draw_round_rect(rectA, pen, (i32) (10 - i));
            ...
            bool FrameSchemaHardCoded008::get_color(COLORREF & cr, ::user::e_color ecolor, ::user::interaction * pinteraction)
            {
               if (m_estyle == StyleLightGreen)
               {
                  ...
                  return ::user::wndfrm::frame::frame::get_color(cr, ecolor, pinteraction);
