...
void simple_dialog::show()
{
   ...
   if (m_pdoc == NULL)
   {
      ...
      m_pdoc = m_pdoctemplate->open_document_file(m_strForm, false);
   ...
   if (m_pform->get_html_data()->m_bImplemented)
   {
      ...
      on_control_event(dynamic_cast < ::user::form_window * > (m_pform.m_p), &ev);
...
bool simple_dialog::on_control_event(::user::form_window * pview, ::user::control_event * pevent)
{
