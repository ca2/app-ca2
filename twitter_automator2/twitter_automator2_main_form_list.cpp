...
string get_file_open(::user::frame * pframe, string strFolder);
string get_file_save(::user::frame * pframe, string strFolder);
...
namespace twitter_automator2
{
   ...
   main_form_list::main_form_list(::aura::application * papp) :
      ::object(papp),
      ::twitter_automator::container(papp),
   ...
   void main_form_list::_001InsertColumns()
   {
      ...
      //}
      {
         ...
         */
         ...
         pcolumn->m_iWidth = 150;
         pcolumn->m_iSubItem = twitter_automator::task::data_cache;
         //pcolumn->m_iControl = _001AddControl(control);
         pcolumn->m_uiText = "CACHE";
         pcolumn->m_bCustomDraw = true;
         _001AddColumn(column);
      ...
      //}
      {
         ...
         pcolumn->m_iSubItem = twitter_automator::task::data_hint_target;
         pcolumn->m_iWidth = 250;
   ...
   bool main_form_list::get_color(COLORREF & cr, ::user::e_color ecolor, ::user::style_context * pcontext)
   {
      ...
      return simple_form_list_view::get_color(cr, ecolor, pcontext);
...
//         m_ptaska->simple_csv_save_file(Context.dir().home() / "Twitter Automator.csv");
   ...
   void main_form_list::_001OnImport(::message::message * pobj)
   {
      ...
      ::fork(get_context_application(), [&]()
      {
         ...
         if (str.is_empty())
         {
            ...
            str = Context.dir().home() / "Twitter Automator";
         ...
         file::path path = get_file_open(GetTopLevelFrame(), str);
   ...
   void main_form_list::_001OnExport(::message::message * pobj)
   {
      ...
      ::fork(get_context_application(), [&]()
      {
         ...
         file::path path = get_file_save(GetTopLevelFrame(), str);
   ...
   void main_form_list::_001OnAddTask(::message::message * pobj)
   {

      {
         ...
         m_ptaska->add(canew(::twitter_automator::task(m_ptaska)));
   ...
   void main_form_list::_001GetItemImage(::user::mesh_item * pitem)
   {
      ...
      if (pitem->m_iSubItem == ::twitter_automator::task::data_hint_target)
      {
   ...
   void main_form_list::_001GetItemColor(::user::mesh_item * pitem)
   {
      ...
      if (pitem->m_iSubItem == ::twitter_automator::task::data_source_api_consumer_sec)
      {
      ...
      if (pitem->m_iSubItem == ::twitter_automator::task::data_target_api_consumer_sec)
      {
      ...
      if (pitem->m_iSubItem == ::twitter_automator::task::data_target_api_token_sec)
      {
   ...
   void main_form_list::_001GetItemText(::user::mesh_item * pitem)
   {
      ...
      else if (pitem->m_iSubItem == ::twitter_automator::task::data_target_api_consumer_sec)
      {

         pitem->m_crText = ARGB(0, 0, 0, 0);

      }
      else if (pitem->m_iSubItem == ::twitter_automator::task::data_target_api_token_sec)
      {
      ...
      if (pitem->m_iSubItem == ::twitter_automator::task::data_status)
      {
      ...
      else if (pitem->m_iSubItem == ::twitter_automator::task::data_cache)
      {

         if (pitem->m_strText.compare_ci("ON") == 0)
         {

            pitem->m_crText = ARGB(255, 50, 100, 150);

         }
         else
         {

            pitem->m_crText = ARGB(255, 140, 120, 100);
   ...
   bool main_form_list::on_click(const ::user::item & item)
   {
      ...
      if (iSubItem == ::twitter_automator::task::data_status)
      {

         ::user::draw_list_item item(this);

         item.m_iSubItem = ::twitter_automator::task::data_status;
      ...
      else if (iSubItem == ::twitter_automator::task::data_cache)
      {

         ::user::draw_list_item item(this);

         item.m_iSubItem = ::twitter_automator::task::data_cache;
   ...
   void   main_form_list::_001DrawSubItem(::user::draw_list_item * pdrawitem)
   {
      ...
      else if (pdrawitem->m_iSubItem == ::twitter_automator::task::data_status)
      {
         ...
         if (pdrawitem->m_bOk)
         {
            ...
            int iMin = MAX(rect.get_size().get_minimum_dimension() / 3, 1);
      ...
      else if (pdrawitem->m_iSubItem == ::twitter_automator::task::data_cache)
      {
         ...
         if (pdrawitem->m_bOk)
         {
            ...
            if (bOk)
            {
               ...
               pdrawitem->m_strText = "ON";

            }
            else
            {

               pdrawitem->m_strText = "OFF";

            }

            COLORREF crPen = ARGB(255, 80, 110, 165);
            ...
            if (bOk)
            {
               ...
               crBrush = ARGB(200, 50, 110, 180);

            }
            else
            {

               crBrush = ARGB(200, 110, 100, 60);
   ...
   void main_form_list::_001DrawItem(::user::draw_list_item * pdrawitem)
   {
      ...
      pdrawitem->m_pgraphics->move_to(rectClient.left, pdrawitem->m_rectItem.bottom-2);
      pdrawitem->m_pgraphics->line_to(rectClient.right, pdrawitem->m_rectItem.bottom-2);

   }

   void main_form_list::on_status_changed(int iTask)
   {
