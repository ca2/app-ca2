...
Section "grbl_merge_tool (required)"
  ...
  File "C:\eco\time\x64\cover\app_ca2_grbl_merge_tool.dll"
  File "C:\eco\time\x64\cover\app_ca2_grbl_merge_tool.exe"
  ...
  File "C:\eco\time\x64\cover\app_ca2_grbl_merge_tool.pdb"
...
installed_redist:
  ...
  ;we are done
  ExecWait '"$INSTDIR\time\x64\cover\app_ca2_grbl_merge_tool.exe" : install' $0
  
  ; Write the installation path into the registry
  WriteRegStr HKLM "SOFTWARE\ca2\app-ca2\grbl_merge_tool" "Install_Dir" "$INSTDIR"
  
  ; Write the uninstall keys for Windows
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\app_ca2_grbl_merge_tool" "DisplayName" "Twitter Auto"
  ...
  CreateShortCut "$DESKTOP\Twitter Auto.lnk" "$INSTDIR\time\x64\cover\app_ca2_grbl_merge_tool.exe" ""
...
Section "Start Menu Shortcuts"
  ...
  CreateShortcut "$SMPROGRAMS\Twitter Auto\Twitter Auto.lnk" "$INSTDIR\time\x64\cover\app_ca2_grbl_merge_tool.exe" "" "$INSTDIR\time\x64\cover\app_ca2_grbl_merge_tool.exe" 0
