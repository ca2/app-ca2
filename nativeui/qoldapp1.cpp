   ...
   void application::update()
   {

      {
         ...
         if (iState == 5)
         {
            ...
            iState = (int)ymodem_send(m_m.get_data(), (int)(u32)m_m.get_size(), (char*)(const char*)strFileName, &::nativeui::total_progress);
...
extern "C"
{
   ...
   void _putchar(int c)
   {
      ...
      nativeui::application::m_pserial->write(&ui, sizeof(ui));
   ...
   int  _getchar(int timeout)
   {
      ...
      if (timeout < 0)
      {
         ...
         while (true)
         {
            ...
            if (nativeui::application::m_pserial->read(&ui, sizeof(ui)) >= 1)
            {
      ...
      else
      {
         ...
         do
         {
            ...
            int iRes = (int) nativeui::application::m_pserial->read(&ui, sizeof(ui));
